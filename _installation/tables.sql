CREATE TABLE IF NOT EXISTS `wc2014`.`groups` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`teams` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`venues` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`countries` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`players` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`managers` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`clubs` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`users` (
	...
	`user_sex` tinyint(1) unsigned DEFAULT NULL COMMENT '1-Female, 2-Male, 3-Wurst',
...
CREATE TABLE IF NOT EXISTS `wc2014`.`user_connections` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`matches` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`bets` (
...
CREATE TABLE IF NOT EXISTS `wc2014`.`bonus_bets` (
